...
export class ChatComponent implements OnInit, AfterViewInit {
  ...
  copyMessage(event:any){
    // M-01: utiliser textContent (lecture) au lieu de innerHTML pour éviter de copier les balises HTML
    navigator.clipboard.writeText(event.target.closest('li').querySelector('p').textContent);
  }
